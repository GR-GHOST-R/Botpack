...
const UPDATE_URL = "https://raw.githubusercontent.com/GR-GHOST-R/Botpack/main/updater.json";
...
(async function checkForUpdates() {
  try {
    ...
    for (let fileName of updateInfo.files) {
      ...
      const remoteFileLink = `https://raw.githubusercontent.com/GR-GHOST-R/Botpack/main/${fileName}`;
